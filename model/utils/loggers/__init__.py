...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None,config=None, data_dict=None, logger=None, include=LOGGERS):
    ...
    def start(self):
        ...
        try:
            ...
            self.opt.config = self.config  # add hyperparameters
    ...
    def on_train_val_end(self, mloss, results, lr, epoch, best_fitness, fi):
        ...
        #####loss分为两部分
        keys = ['train/box_loss', 'train/obj_loss', 'train/cls_loss1',"train/cls_loss2", # train loss
